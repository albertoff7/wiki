...
return [
    ...
    'timestamp' => 1597817734,
    'checksum' => '649d9a0396ecfc03a2637b22df675d43',
    'files' => [
        'user/config' => [
            'backups' => [
...
node_modules'
        ...
        'site' => [
            'title' => 'Wiki alberto WS',
            'default_lang' => 'es',
            'author' => [
                'name' => 'Alberto',
                'email' => 'albertof417@gmail.com'
            ],
            'taxonomies' => [
                0 => 'category',
                1 => 'tag'
            ...
            'metadata' => [
                'description' => 'wiki personal de alberto ws webservices'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
